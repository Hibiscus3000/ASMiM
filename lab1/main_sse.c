...
{
    double *result = (double *)_mm_malloc(sizeof(__m128d), sizeof(__m128d));
    __m128d vect = _mm_set_pd(100000.0,400000.0);
...
void measure_reciprocal_throughput(int rtfd)
{
    ...
    double *result = (double *)_mm_malloc(sizeof(__m128d), sizeof(__m128d));
    __m128d *vects = (__m128d *)_mm_malloc(number_of_ind_vects * sizeof(__m128d),sizeof(__m128d));
    ...
    _mm_store_pd(result, vects[number_of_ind_vects / 2 + number_of_ind_vects / 4]);
