...
.L18:
	...
	vaddpd	%ymm1, %ymm0, %ymm1
	vmovntdqa	256(%rdi,%rax), %ymm0
	vaddpd	%ymm1, %ymm0, %ymm1
	vmovntdqa	288(%rdi,%rax), %ymm0
	vaddpd	%ymm1, %ymm0, %ymm1
	vmovntdqa	320(%rdi,%rax), %ymm0
	vaddpd	%ymm1, %ymm0, %ymm1
	vmovntdqa	352(%rdi,%rax), %ymm0
	vaddpd	%ymm1, %ymm0, %ymm1
	vmovntdqa	384(%rdi,%rax), %ymm0
	vaddpd	%ymm1, %ymm0, %ymm1
	vmovntdqa	416(%rdi,%rax), %ymm0
	vaddpd	%ymm1, %ymm0, %ymm1
	vmovntdqa	448(%rdi,%rax), %ymm0
	vaddpd	%ymm1, %ymm0, %ymm1
	vmovntdqa	480(%rdi,%rax), %ymm0
	vaddpd	%ymm1, %ymm0, %ymm1
	addq	$16,	%rcx
.L16:
	movq	%rcx, %rax
...
.L26:
	...
	vmovntdq	%ymm0, 256(%rdi,%rax)
	vmovntdq	%ymm0, 288(%rdi,%rax)
	vmovntdq	%ymm0, 320(%rdi,%rax)
	vmovntdq	%ymm0, 352(%rdi,%rax)
	vmovntdq	%ymm0, 384(%rdi,%rax)
	vmovntdq	%ymm0, 416(%rdi,%rax)
	vmovntdq	%ymm0, 448(%rdi,%rax)
	vmovntdq	%ymm0, 480(%rdi,%rax)
	addq	$16, %rcx
.L25:
	cmpq	%r13, %rcx
	jl	.L26
...
.L33:
	...
	vmovntdqa	256(%rbx,%r12), %ymm0
	vmovntdq	%ymm0, 256(%rbx,%r13)
	vmovntdqa	288(%rbx,%r12), %ymm0
	vmovntdq	%ymm0, 288(%rbx,%r13)
	vmovntdqa	320(%rbx,%r12), %ymm0
	vmovntdq	%ymm0, 320(%rbx,%r13)
	vmovntdqa	352(%rbx,%r12), %ymm0
	vmovntdq	%ymm0, 352(%rbx,%r13)
	vmovntdqa	384(%rbx,%r12), %ymm0
	vmovntdq	%ymm0, 384(%rbx,%r13)
	vmovntdqa	416(%rbx,%r12), %ymm0
	vmovntdq	%ymm0, 416(%rbx,%r13)
	vmovntdqa	448(%rbx,%r12), %ymm0
	vmovntdq	%ymm0, 448(%rbx,%r13)
	vmovntdqa	480(%rbx,%r12), %ymm0
	vmovntdq	%ymm0, 480(%rbx,%r13)
	sarq	$5, %rbx
	addq	$8,	%rbx
.L32:
	cmpq	16(%rsp), %rbx
