...
.L18:
	...
	vmovntdq	%ymm0, 256(%rcx)
	vmovntdq	%ymm0, 288(%rcx)
	vmovntdq	%ymm0, 320(%rcx)
	vmovntdq	%ymm0, 352(%rcx)
	vmovntdq	%ymm0, 384(%rcx)
	vmovntdq	%ymm0, 416(%rcx)
	vmovntdq	%ymm0, 448(%rcx)
	vmovntdq	%ymm0, 480(%rcx)
	addq	$512, %rcx
	cmpq	%rsi, %rcx
	jl	.L18
.L17:
...
.L39:
	...
	vmovntdqa	256(%r12,%rcx), %ymm0
	vmovntdq	%ymm0, 256(%rdi,%rcx)
	vmovntdqa	288(%r12,%rcx), %ymm0
	vmovntdq	%ymm0, 288(%rdi,%rcx)
	vmovntdqa	320(%r12,%rcx), %ymm0
	vmovntdq	%ymm0, 320(%rdi,%rcx)
	vmovntdqa	352(%r12,%rcx), %ymm0
	vmovntdq	%ymm0, 352(%rdi,%rcx)
	vmovntdqa	384(%r12,%rcx), %ymm0
	vmovntdq	%ymm0, 384(%rdi,%rcx)
	vmovntdqa	416(%r12,%rcx), %ymm0
	vmovntdq	%ymm0, 416(%rdi,%rcx)
	vmovntdqa	448(%r12,%rcx), %ymm0
	vmovntdq	%ymm0, 448(%rdi,%rcx)
	vmovntdqa	480(%r12,%rcx), %ymm0
	vmovntdq	%ymm0, 480(%rdi,%rcx)
	addq	$512, %rcx
	cmpq	%rsi, %rcx
	jl	.L39
.L38:
